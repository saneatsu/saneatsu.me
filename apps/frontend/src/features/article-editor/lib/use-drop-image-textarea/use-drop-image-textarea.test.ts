...
import { useDropImageTextarea } from "./use-drop-image-textarea";
...
describe("Unit Test", () => {
	describe("useDropImageTextarea", () => {
		...
		it("should upload and insert image when dropping image", async () => {
			...
			renderHook(() =>
				useDropImageTextarea(textareaRef, mockUploadImage, mockOnChange)
			);
			...
			// Act
			mockTextarea.dispatchEvent(dropEvent);
		...
		it("should prevent default on dragover", () => {
			...
			// Act
			mockTextarea.dispatchEvent(dragoverEvent);
		...
		it("should prevent duplicate uploads when already uploading", async () => {
			...
			mockTextarea.dispatchEvent(dropEvent1);
			...
			mockTextarea.dispatchEvent(dropEvent2);
