...
import type { TechStackName } from "@/shared/config";

// 技術スタック名の定義はSSOT（shared/config/tech-stack.ts）に集約している。
// 従来 `@/shared/types` から `TechStackName` をimportしていた箇所を壊さないよう再エクスポートする。
